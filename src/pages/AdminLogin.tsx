...
const AdminLogin = () => {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    if (!client) {
      setError("Backend niet beschikbaar. Probeer later opnieuw.");
      setLoading(false);
      return;
    }
          ...
          <form onSubmit={handleLogin} className="space-y-5">
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input id="email" type="email" value={email} onChange={(e) => setEmail(e.target.value)} placeholder="admin@belgomed.be" className="pl-10 bg-secondary/50 border-border/50 focus:border-primary" required />
              </div>
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input id="password" type="password" value={password} onChange={(e) => setPassword(e.target.value)} placeholder="••••••••" className="pl-10 bg-secondary/50 border-border/50 focus:border-primary" required />
              </div>
            </div>
