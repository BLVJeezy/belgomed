      ...
      <section className="py-20 lg:py-24 bg-slate-50 border-y border-slate-200 px-6 lg:px-12">
        <div className="container mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12">
            <div className="p-8 lg:p-10 bg-white shadow-sm border-t-4 border-primary">
              <div className="text-3xl font-black mb-3 text-[#001a1a]">45+</div>
              <p className="text-[10px] uppercase font-black text-slate-400 tracking-widest mb-2">Jaren Ervaring</p>
              <p className="text-xs text-slate-500 italic">Expertise in export naar Centraal-Afrika.</p>
            </div>
            <div className="p-8 lg:p-10 bg-white shadow-sm border-t-4 border-[#001a1a]">
              <div className="text-3xl font-black mb-3 text-[#001a1a]">FAGG</div>
              <p className="text-[10px] uppercase font-black text-slate-400 tracking-widest mb-2">Regulering</p>
              <p className="text-xs text-slate-500 italic">Strikte naleving van alle farmaceutische wetgeving.</p>
            </div>
            <div className="p-8 lg:p-10 bg-white shadow-sm border-t-4 border-slate-300">
              <div className="text-3xl font-black mb-3 text-[#001a1a]">WDA</div>
              <p className="text-[10px] uppercase font-black text-slate-400 tracking-widest mb-2">Licensed</p>
              <p className="text-xs text-slate-500 italic">Uw geautoriseerde groothandel voor medicijnen.</p>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="relative">
            ...
            <div className="space-y-12">
              {timelineEvents.map((event, i) => (
                <div key={event.year} className={`relative flex items-start gap-8 ${i % 2 === 0 ? "lg:flex-row" : "lg:flex-row-reverse"}`}>
                  {/* Dot */}
      ...
      <section className="py-20 lg:py-24 bg-gradient-to-r from-[#001a1a] to-[#004d4d] px-6 lg:px-12">
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {pillars.map((p) => (
              <div key={p.title} className="p-8 lg:p-10 border border-white/10 bg-white/5 backdrop-blur-sm rounded-sm text-center">
