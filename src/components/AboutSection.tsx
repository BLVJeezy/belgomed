...
const AboutSection = () => {
  return (
    <div id="overons">
      ...
      {/* Expertise */}
      <section className="py-20 lg:py-24 bg-secondary px-6 lg:px-12">
        <div className="container mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-20 items-center">
          ...
          <ScrollReveal delay={0.2}>
            <div className="aspect-square relative overflow-hidden group rounded-sm">
              ...
              <div className="absolute bottom-8 left-8 text-foreground z-10">
      ...
      {/* Values / Pillars */}
      <section className="py-20 lg:py-24 bg-background px-6 lg:px-12">
        <div className="container mx-auto">
          <ScrollReveal>
            <p className="text-[10px] font-black text-primary uppercase tracking-[0.4em] mb-4 text-center">Onze Waarden</p>
            <h3 className="text-3xl lg:text-4xl font-black text-foreground mb-16 uppercase leading-none text-center">
              Drie Pijlers
            </h3>
          </ScrollReveal>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {pillars.map((p, i) => (
              <ScrollReveal key={p.title} delay={i * 0.15}>
                <div className="p-8 lg:p-10 border border-border bg-card backdrop-blur-sm rounded-sm text-center">
                  <p.icon className="w-8 h-8 text-primary mx-auto mb-5" />
                  <h4 className="text-lg font-black text-foreground uppercase tracking-wide mb-3">{p.title}</h4>
